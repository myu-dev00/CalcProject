...
public class Calculator {
    ...
    private void saveOutput(Double rt) {
        String stringResult = Double.toString(rt);
        ...
        if ((decimalDigit == 1) && (stringResult.charAt(naturalNumIdx + 1) == '0')) { //소수점이 '0'인 정수일때
            stringResult = String.format("%d", (int) (double) rt);
        } else if (decimalDigit == 1) {
            stringResult = String.format("%.1f", rt);
        } else if (decimalDigit == 2) {
            stringResult = String.format("%.2f", rt);
        } else {
            stringResult = String.format("%.3f", rt);
            ...
            if (stringResult.equals("0.000")) {
                ...
                stringResult = String.format("%.9e", rt);
            }
        }
